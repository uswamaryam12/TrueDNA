def Knee(structure, functions, health, disease, recover, adaptations,timeChart, misc):
    ...
    functions = [growth_rate, pain_perception,  knee_structure,  knee_circumference, hormone_regulation]
    health = [knee_health, bone_health, muscle_health]
    disease = [knee_disorder, genetic_disease, allergies, wound_density, susceptibility_disease, cancer]
    recover = [resistance_genetic_disease, wound_heal]
    adaptations = [environmental_adaptations]
    timeChart = [developmental_timing]
    misc = [size, shape, age_factor, strength]
